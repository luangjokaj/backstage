...
The rest of this page is focused on adding the `todo-list` and `todo-list-backend` plugins to your Backstage instance. If you want to add support for permissions to your own plugin instead, feel free to skip to the [next section](/permissions/plugin-authors/02-adding-a-basic-permission-check).

## Setup for the Tutorial

**Note**: We will be updating files created as part of the [Getting Started](/permissions/getting-started) documentation, this tutorial assumes you have already viewed and gone through those steps!
