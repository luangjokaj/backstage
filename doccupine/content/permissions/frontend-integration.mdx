...
Now that we understand how to [author a permission policy](/permissions/writing-a-policy), let's consider cases where we'll need to supplement our policy with authorization checks on the frontend.
