...
[The previous section](/auth) covered the various _authentication_ methods of Backstage, but Backstage can also _authorize_ specific data, APIs, or interface actions - meaning that Backstage has the ability to enforce rules about what type of access is allowed for a given user of a system.
...
See the "[getting started](/permissions/getting-started)" permission documentation for Backstage integrators.

If you are a plugin author, see the permission [documentation for plugin authors](/permissions/plugin-authors/01-setup) on how to integrate permissions into your plugin.
