...
[The IdentityResolver docs](/auth/identity-resolver) describe the process for resolving group membership on sign in.
...
Congratulations! Now that the framework is fully configured, you can craft a permission policy that works best for your organization by [writing your own policy](/permissions/writing-a-policy)!
