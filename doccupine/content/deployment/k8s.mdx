...
[also uses](/features/software-catalog/descriptor-format) the Kubernetes
...
To create the Backstage deployment, first create a [Docker image](/deployment/docker).
...
If you're using an [auth provider](/auth), it should also have this
