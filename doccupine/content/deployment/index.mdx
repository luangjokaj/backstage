...
This method is covered in [Building a Docker image](/deployment/docker) and
...
If you need to run Backstage behind a corporate proxy, see the [corporate proxy guide](/tutorials/corporate-proxy).
