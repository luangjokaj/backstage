...
See the
[backend system documentation](/backend-system/building-backends/01-index#split-into-multiple-backends)
...
[Scaling Backstage Deployments](/deployment/scaling) reference
documentation.
