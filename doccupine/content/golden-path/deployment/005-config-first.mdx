...
The Docker image built in the [first step](/golden-path/deployment/001-docker) starts with this
command:
...
[Configuration documentation](/conf).
...
- [Monitoring your deployment](/golden-path/deployment/006-monitoring)
