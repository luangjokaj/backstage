...
# Deploying Backstage to production

## Prerequisites

- You have completed the [create-app golden path](/golden-path/create-app) and
...
- [Building the Docker image](/golden-path/deployment/001-docker)
