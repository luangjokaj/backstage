...
Follow the [Setup OpenTelemetry tutorial](/tutorials/setup-opentelemetry)
...
See the [Analytics documentation](/frontend-system/building-plugins/08-analytics)
...
- [Scaling your deployment](/golden-path/deployment/007-scaling)
