...
We hope at this point that the developers you're working with have read the [golden path on deploying Backstage](/golden-path/deployment). Your Backstage instance should be ready for the scale that comes with a full company launch.
...
an analytics provider through the plugin ecosystem, you can find more information on this in the [Analytics](/plugins/analytics) section of the Backstage documentation. Tracking which parts of
