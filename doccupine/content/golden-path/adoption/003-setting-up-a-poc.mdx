...
Follow [our golden path for creating an app](/golden-path/create-app). Once you have that set up, we recommend adding a few `catalog-info.yaml` files to a few repos/projects you own and setting up [the GitHub catalog provider](/integrations/github/discovery).
