...
- [Why build plugins?](/golden-path/plugins/why-build-plugins)
- [Sustainable plugin development](/golden-path/plugins/sustainable-plugin-development)
- [Golden path: Backend plugins](/golden-path/plugins/backend/001-first-steps)
- [Golden path: Frontend plugins](/golden-path/plugins/frontend/001-first-steps)
