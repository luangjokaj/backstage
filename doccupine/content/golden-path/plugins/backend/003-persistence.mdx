...
To validate this flow, let's use the same commands that we ran in [the last section of this guide](/golden-path/plugins/backend/002-poking-around#testing-locally).
