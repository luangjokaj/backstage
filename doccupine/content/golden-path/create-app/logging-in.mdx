...
# 004 - Logging into your instance
...
You should have completed the GitHub OAuth app setup defined in [the authentication tutorial](/getting-started/config/authentication).
