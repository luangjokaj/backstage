...
# 005 - Customize your App's theme

<Callout type="info">

This documentation is written for the new frontend system, which is the default
in new Backstage apps. If your Backstage app still uses the old frontend system,
read the [old frontend system version of this guide](/golden-path/create-app/customize-theme--old)
instead.
...
In the new frontend system, the sidebar is managed by the built-in `app/nav` extension. You can customize it by creating a `NavContentBlueprint` extension. See the [sidebar customization](/frontend-system/building-apps/08-migrating#app-root-sidebar) documentation for detailed instructions on creating a custom sidebar layout with sub-menus and custom grouping.

## Custom Homepage

In addition to a custom theme, a custom logo, you can also customize the
homepage of your app. Read the full guide on the [next page](/getting-started/homepage).

## Migrating to Material UI v5

We now support Material UI v5 in Backstage. Check out our [migration guide](/tutorials/migrate-to-mui5) to get started.
