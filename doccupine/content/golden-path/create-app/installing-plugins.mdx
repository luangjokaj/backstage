...
You'll generally have multiple packages that combine into a single "plugin". The common naming standard (detailed in [ADR-11](/architecture-decisions/adr011-plugin-package-structure)) is demonstrated below for plugin `x`:
