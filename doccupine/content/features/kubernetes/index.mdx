...
To get started, first you must [install the Kubernetes plugins](/features/kubernetes/installation)
and then [configure them](/features/kubernetes/configuration).
