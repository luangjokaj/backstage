...
If you haven't set up Backstage already, read the [Getting Started](/getting-started) guide.
...
[configure them](/features/kubernetes/configuration).

## Troubleshooting

After installing the plugins in the code, if the Kubernetes information is not
showing up, you'll need to [troubleshoot it](/features/kubernetes/troubleshooting).
