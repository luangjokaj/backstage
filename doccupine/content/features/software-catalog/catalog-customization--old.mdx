...
# Catalog Customization (Old Frontend System)
...
[current guide](/features/software-catalog/catalog-customization) instead.
...
Possible options are all the [default Kinds](/features/software-catalog/system-model) as well as any custom Kinds that you have added.
