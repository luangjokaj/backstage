...
[entity statuses](/features/software-catalog/descriptor-format#common-to-all-kinds-status), that have
...
[descriptor format](/features/software-catalog/descriptor-format#common-to-all-kinds-status) section.
