...
others. The most common source is [YAML files](/features/software-catalog/descriptor-format) on a
...
sufficient information for a reader to find the causes for errors. See the [configuration documentation](/features/software-catalog/configuration#subscribing-to-catalog-errors) for how to subscribe and log these error events.
...
described in the [External integrations](/features/software-catalog/external-integrations) article. They
