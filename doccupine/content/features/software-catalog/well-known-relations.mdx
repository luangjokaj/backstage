...
[entity relation types](/features/software-catalog/descriptor-format#common-to-all-kinds-relations),
...
[Extending the model](/features/software-catalog/extending-the-model).
...
([User](/features/software-catalog/descriptor-format#kind-user) or
[Group](/features/software-catalog/descriptor-format#kind-group)), and the other entity can be anything.
...
A relation with an [API](/features/software-catalog/descriptor-format#kind-api) entity, typically from a
[Component](/features/software-catalog/descriptor-format#kind-component).
...
organizational structure between [Groups](/features/software-catalog/descriptor-format#kind-group).

This relation is commonly based on `spec.parent` and/or `spec.children`.

### `memberOf` and `hasMember`

A membership relation, typically for [Users](/features/software-catalog/descriptor-format#kind-user) in
[Groups](/features/software-catalog/descriptor-format#kind-group).

This relation is commonly based on `spec.memberOf`.

### `partOf` and `hasPart`

A relation with a [Domain](/features/software-catalog/descriptor-format#kind-domain),
[System](/features/software-catalog/descriptor-format#kind-system) or
[Component](/features/software-catalog/descriptor-format#kind-component) entity, typically from a
[Component](/features/software-catalog/descriptor-format#kind-component),
[API](/features/software-catalog/descriptor-format#kind-api),
[System](/features/software-catalog/descriptor-format#kind-system), or
[Domain](/features/software-catalog/descriptor-format#kind-domain),
