...
[annotations](/features/software-catalog/descriptor-format#annotations-optional), that have defined
...
This annotation can be used on a [Group entity](/features/software-catalog/descriptor-format#kind-group)
...
This annotation can be used on a [User entity](/features/software-catalog/descriptor-format#kind-user)
...
[substitution](/features/software-catalog/descriptor-format#substitutions-in-the-descriptor-format)
instead.
...
- [Descriptor Format: annotations](/features/software-catalog/descriptor-format#annotations-optional)
