...
[ADR005](/architecture-decisions/adr005-catalog-core-entities) describes
...
understand their semantics. See [Extending the model](/features/software-catalog/extending-the-model)
...
for simplicity until it's necessary to use supplemental ones. See [the references article](/features/software-catalog/references) for more information.
...
always use [string-form entity reference](/features/software-catalog/references#string-references)
instead.
...
the code. [Entity references](/features/software-catalog/references) still always make use of the `name`
...
There is a list of [well-known annotations](/features/software-catalog/well-known-annotations), but
...
[well-known relations section](/features/software-catalog/well-known-relations). Relations are commonly
...
| Field       | Type   | Description                                                                |
| ----------- | ------ | -------------------------------------------------------------------------- |
| `targetRef` | String | A full [entity reference](/features/software-catalog/references) to the other end of the relation. |
...
See the [well-known relations section](/features/software-catalog/well-known-relations) for a list of
...
[well-known statuses section](/features/software-catalog/well-known-statuses).
...
See the [well-known statuses section](/features/software-catalog/well-known-statuses) for a list of
...
An [entity reference](/features/software-catalog/references#string-references) to the owner of the
...
| [`kind`](#apiversion-and-kind-required)                | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                              |
| ------------------------------------------------------ | ------------------------------------------ | ------------------------------------------------------------------------------- |
| [`Group`](#kind-group) (default), [`User`](#kind-user) | Same as this entity, typically `default`   | [`ownedBy`, and reverse `ownerOf`](/features/software-catalog/well-known-relations#ownedby-and-ownerof) |

### `spec.system` [optional]

An [entity reference](/features/software-catalog/references#string-references) to the system that the
component belongs to, e.g. `artist-engagement-portal`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                            |
| --------------------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| [`System`](#kind-system) (default)      | Same as this entity, typically `default`   | [`partOf`, and reverse `hasPart`](/features/software-catalog/well-known-relations#partof-and-haspart) |

### `spec.subcomponentOf` [optional]

An [entity reference](/features/software-catalog/references#string-references) to another component of
which the component is a part, e.g. `spotify-ios-app`. This field is optional.

| [`kind`](#apiversion-and-kind-required)  | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                            |
| ---------------------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| [`Component`](#kind-component) (default) | Same as this entity, typically `default`   | [`partOf`, and reverse `hasPart`](/features/software-catalog/well-known-relations#partof-and-haspart) |

### `spec.providesApis` [optional]

An array of [entity references](/features/software-catalog/references#string-references) to the APIs
that are provided by the component, e.g. `artist-api`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                                  |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| [`API`](#kind-api) (default)            | Same as this entity, typically `default`   | [`providesApi`, and reverse `apiProvidedBy`](/features/software-catalog/well-known-relations#providesapi-and-apiprovidedby) |
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                                  |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| [`API`](#kind-api) (default)            | Same as this entity, typically `default`   | [`consumesApi`, and reverse `apiConsumedBy`](/features/software-catalog/well-known-relations#consumesapi-and-apiconsumedby) |

### `spec.dependsOn` [optional]

An array of [entity references](/features/software-catalog/references#string-references) to the
components and resources that the component depends on, e.g. `artists-db`. This
field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                            |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [`Component`](#kind-component)          | Same as this entity, typically `default`   | [`dependsOn`, and reverse `dependencyOf`](/features/software-catalog/well-known-relations#dependson-and-dependencyof) |
| [`Resource`](#kind-resource)            | Same as this entity, typically `default`   | [`dependsOn`, and reverse `dependencyOf`](/features/software-catalog/well-known-relations#dependson-and-dependencyof) |
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                            |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [`Component`](#kind-component)          | Same as this entity, typically `default`   | [`dependencyOf`, and reverse `dependsOn`](/features/software-catalog/well-known-relations#dependson-and-dependencyof) |
| [`Resource`](#kind-resource)            | Same as this entity, typically `default`   | [`dependencyOf`, and reverse `dependsOn`](/features/software-catalog/well-known-relations#dependson-and-dependencyof) |
...
[here](/features/software-templates/writing-templates)
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------- |
| [`Group`](#kind-group) (default)        | Same as this entity, typically `default`   | [`childOf`, and reverse `parentOf`](/features/software-catalog/well-known-relations#parentof-and-childof) |
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                |
| --------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------- |
| [`Group`](#kind-group) (default)        | Same as this entity, typically `default`   | [`parentOf`, and reverse `childOf`](/features/software-catalog/well-known-relations#parentof-and-childof) |
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                    |
| --------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------- |
| [`User`](#kind-user) (default)          | Same as this entity, typically `default`   | [`hasMember`, and reverse `memberOf`](/features/software-catalog/well-known-relations#memberof-and-hasmember) |
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                                    |
| --------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------- |
| [`Group`](#kind-group) (default)        | Same as this entity, typically `default`   | [`memberOf`, and reverse `hasMember`](/features/software-catalog/well-known-relations#memberof-and-hasmember) |
...
An [entity reference](/features/software-catalog/references#string-references) to the domain that the
system belongs to, e.g. `artists`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/features/software-catalog/well-known-relations) type                            |
| --------------------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| [`Domain`](#kind-domain) (default)      | Same as this entity, typically `default`   | [`partOf`, and reverse `hasPart`](/features/software-catalog/well-known-relations#partof-and-haspart) |
...
An [entity reference](/features/software-catalog/references#string-references) to another domain of
