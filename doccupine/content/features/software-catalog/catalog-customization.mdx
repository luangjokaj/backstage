...
read the [old frontend system version of this guide](/features/software-catalog/catalog-customization--old)
instead.
...
available, see the [extension overrides](/frontend-system/architecture/25-extension-overrides) documentation.
