...
[Component](/features/software-catalog/descriptor-format#kind-component) entity may want to declare who
...
[kind](/features/software-catalog/descriptor-format#apiversion-and-kind-required),
[namespace](/features/software-catalog/descriptor-format#namespace-optional), and
[name](/features/software-catalog/descriptor-format#name-required). But that's a lot to type out
