...
concept of [metadata YAML files](/features/software-catalog/descriptor-format) stored together with the
...
The source of truth for the components in your software catalog are [metadata YAML files](/features/software-catalog/descriptor-format) stored in source control (GitHub, GitHub
...
3. Integrating with an [external source](/features/software-catalog/external-integrations)
...
[Backstage Software Templates](/features/software-templates) are automatically
registered in the catalog.

### Static catalog configuration

In addition to manually registering components, it is also possible to register
components through [static configuration](/conf). For example, the
...
[here](/features/software-catalog/configuration).
...
or by [building your own](/plugins).
