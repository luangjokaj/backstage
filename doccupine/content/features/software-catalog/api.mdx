...
[The Life of an Entity](/features/software-catalog/life-of-an-entity) for more details about this process and
distinction.
...
- Return all users who are members of the `ops` group (note that the full
  [reference](/features/software-catalog/references) of the group is used):
...
The return type is JSON, as an array of [`Entity`](/features/software-catalog/descriptor-format).
...
The return type is JSON, as a single [`Entity`](/features/software-catalog/descriptor-format), or a 404
...
[reference](/features/software-catalog/references) triplet.
