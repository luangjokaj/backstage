...
# Getting Started with Search (Old Frontend System)
...
[current guide](/features/search/getting-started) instead.
...
> For more advanced customization of the Search frontend, also see how to guides such as [How to implement your own Search API](/features/search/how-to-guides--old#how-to-implement-your-own-search-api) and [How to customize search results highlighting styling](/features/search/how-to-guides--old#how-to-customize-search-results-highlighting-styling)
...
> For more advanced customization of the Search backend, also see how to guides such as [How to customize fields in the Software Catalog or TechDocs index](/features/search/how-to-guides--old#how-to-customize-fields-in-the-software-catalog-or-techdocs-index)
