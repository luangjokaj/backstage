...
read the [old frontend system version of this guide](/features/search/how-to-guides--old)
instead.
...
[theming documentation](/frontend-system/building-apps/02-configuring-extensions)
