...
See the more detailed [architecture](/features/search/architecture) and [tech stack](/features/search/architecture#tech-stack).
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| Software Catalog                                                                                                                                                              | ✅             |
| [TechDocs](/features/search/how-to-guides#how-to-customize-fields-in-the-software-catalog-or-techdocs-index)                                                                              | ✅             |
...
See [Backstage Search Architecture](/features/search/architecture) to get an overview of how
the search engines are used.

| Search Engines                                                | Support Status |
| ------------------------------------------------------------- | -------------- |
| [Elasticsearch/OpenSearch](/features/search/search-engines#elasticsearch) | ✅             |
| [Lunr](/features/search/search-engines#lunr)                              | ✅             |
| [Postgres](/features/search/search-engines#postgres)                      | Community ✅   |
