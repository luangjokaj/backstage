...
[Template Entity](/features/software-catalog/descriptor-format#kind-template)
...
[static location configuration](/features/software-catalog/configuration#static-location-configuration),
for example:
