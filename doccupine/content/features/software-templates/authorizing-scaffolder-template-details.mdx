...
The scaffolder plugin integrates with the Backstage [permission framework](/permissions/overview), which allows you to control access to certain parameters and steps in your templates based on the user executing the template. It also allows you to control access to scaffolder tasks.

<Callout type="success">

To better understand the following examples make sure to review the [Writing a permission policy](/permissions/writing-a-policy)) documentation before moving forward.
