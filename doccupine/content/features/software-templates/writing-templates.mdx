...
If you find that the default layout of the form used in a particular step does not meet your needs then you can supply your own [custom step layout](/features/software-templates/writing-custom-step-layouts).
...
For a list of all possible `ui:options` input props for `RepoUrlPicker`, please visit [here](/features/software-templates/ui-options-examples#repourlpicker).

The `RepoUrlPicker` is a custom field that we provide part of the
`plugin-scaffolder`. You can provide your own custom fields by
[writing your own Custom Field Extensions](/features/software-templates/writing-custom-field-extensions)
...
Note, that you will need to configure an [authentication provider](/auth#configuring-authentication-providers), alongside the
[`ScmAuthApi`](/auth#custom-scmauthapi-implementation) for your source code management (SCM) service to make this feature work.
...
For a list of all possible `ui:options` input props for `RepoBranchPicker`, please visit [here](/features/software-templates/ui-options-examples#repobranchpicker).
...
For a list of all possible `ui:options` input props for `RepoOwnerPicker`, please visit [here](/features/software-templates/ui-options-examples#repoownerpicker).
...
If you have enabled a sign in provider and have a [sign in resolver](/auth/identity-resolver) that points to a user in the Catalog, then you can use the `${{ user.entity }}` templating expression to access the raw entity from the Catalog.
...
For a list of all possible `ui:options` input props for `OwnerPicker`, please visit [here](/features/software-templates/ui-options-examples#ownerpicker).
...
By default we ship some [built in actions](/features/software-templates/builtin-actions) that you can
take a look at, or you can
[create your own custom actions](/features/software-templates/writing-custom-actions).
...
[built in actions](/features/software-templates/builtin-actions).
...
[Templating Extensions](/features/software-templates/templating-extensions).
