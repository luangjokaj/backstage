...
This page answers frequently asked questions about [TechDocs](/features/techdocs).
...
The value of
[`backstage.io/techdocs-ref`](/features/software-catalog/well-known-annotations#backstageiotechdocs-ref)
metadata annotation is used in the build process of TechDocs. But when
[`techdocs.builder`](/features/techdocs/configuration) is set to `'external'` in
