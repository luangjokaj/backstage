...
# Getting Started (Old Frontend System)
...
[current guide](/features/techdocs/getting-started) instead.
...
If you haven't setup Backstage already, start [here](/getting-started).
...
**See [TechDocs Configuration Options](/features/techdocs/configuration) for complete
...
[TechDocs Architecture](/features/techdocs/architecture). But if you want to get started quickly
...
[Publisher](/features/techdocs/concepts#techdocs-publisher). Examples: Google Cloud Storage,
...
[Using Cloud Storage](/features/techdocs/using-cloud-storage).
