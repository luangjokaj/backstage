...
This documentation is written for [the new frontend system](/frontend-system). If you are on the [old frontend system](/features/techdocs/getting-started--old#adding-techdocs-frontend-plugin) you may want to read [its own article](/features/techdocs/addons--old) instead.
