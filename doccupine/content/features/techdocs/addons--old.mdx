...
This documentation is written for [the old frontend system](/features/techdocs/getting-started--old#adding-techdocs-frontend-plugin). If you are on the [new frontend system](/frontend-system) you may want to read [its own article](/features/techdocs/addons) instead.
...
If you are using a custom [TechDocs reader page](/features/techdocs/how-to-guides#how-to-customize-the-techdocs-reader-page) your setup will be very similar, here's an example:
