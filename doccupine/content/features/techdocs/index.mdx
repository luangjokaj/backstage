...
- Take advantage of the [TechDocs Addon Framework](/features/techdocs/addons) to add features on top of the base docs-like-code experience.
...
See [TechDocs Architecture](/features/techdocs/architecture) to get an overview of where the below providers are used.
...
- [Instructions for upgrading from Alpha to Beta](/features/techdocs/how-to-guides#how-to-migrate-from-techdocs-alpha-to-beta)
