...
read the [old frontend system version of this guide](/features/techdocs/how-to-guides--old)
instead.
...
benefits in the [TechDocs Architecture](/features/techdocs/architecture).
...
[using cloud storage](/features/techdocs/using-cloud-storage) in TechDocs.
...
[configuring CI/CD](/features/techdocs/configuring-ci-cd).
...
docs. Look at [TechDocs configuration](/features/techdocs/configuration) for reference.
...
[Prepare](/features/techdocs/concepts#techdocs-preparer) step.
...
[extension overrides](/frontend-system/architecture/25-extension-overrides) documentation.
...
extension. See the [extension overrides](/frontend-system/architecture/25-extension-overrides) documentation for details.
...
2. Override the default API extensions by creating custom API extensions using
   ...
   in your app. See the [Utility APIs](/frontend-system/utility-apis/01-index) documentation for details on how to create and install custom API extensions.
...
The
[`backstage.io/techdocs-ref` annotation](/features/software-catalog/well-known-annotations#backstageiotechdocs-ref)
...
One limitation of the [Recommended deployment](/features/techdocs/architecture#recommended-deployment) is that
...
To accommodate both of these use-cases, users can implement a custom [Build Strategy](/features/techdocs/concepts#techdocs-build-strategy)
