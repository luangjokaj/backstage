...
In the [TechDocs architecture](/features/techdocs/architecture) you have the option to choose
...
If you already have an [AWS S3 integration](/integrations/aws-s3/locations), you can use it to authenticate with AWS S3:
