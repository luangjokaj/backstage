...
- A working Backstage instance with TechDocs installed (see
  [TechDocs getting started](/features/techdocs/getting-started))
...
[How to add documentation setup to your software templates](/features/techdocs/how-to-guides#how-to-add-the-documentation-setup-to-your-software-templates)
to get started.
...
- An existing entity
  [registered in backstage](/features/software-catalog#adding-components-to-the-catalog)
...
1.  Create a `mkdocs.yml` file in the root of your repository with the following
    ...
    mkdocs file if it is missing. This functionality can be turned off with a [configuration option](/features/techdocs/configuration) in Backstage.
    :::
...
4. Register your component in the software catalog using
   [one of several options](/features/software-catalog#adding-components-to-the-catalog).
