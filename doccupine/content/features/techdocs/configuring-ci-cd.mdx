...
In the [Recommended deployment setup](/features/techdocs/architecture#recommended-deployment),
...
storage using [`techdocs-cli`](/features/techdocs/cli).
...
Take a look at [`techdocs-cli`](/features/techdocs/cli) for the complete command reference,
details, and options.
...
[`techdocs-cli generate`](/features/techdocs/cli#generate-techdocs-site-from-a-documentation-project)
...
And then run the
[`techdocs-cli publish`](/features/techdocs/cli#publish-generated-techdocs-sites) command.
...
[TechDocs supported cloud storage providers](/features/techdocs#supported).

Add a `.github/workflows/techdocs.yml` file in your
[Software Template(s)](/features/software-templates) like this -
