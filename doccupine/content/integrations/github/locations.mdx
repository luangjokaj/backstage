...
[static catalog configuration](/features/software-catalog/configuration),
registered with the
[catalog-import](https://github.com/backstage/backstage/tree/master/plugins/catalog-import)
plugin, or [discovered](/integrations/github/discovery) from a GitHub organization. Users and
Groups can also be [loaded from an organization](/integrations/github/org).
...
has higher rate limits, and a clearer authorization model. See [github-apps](/integrations/github/github-apps) for
how to set this up.
