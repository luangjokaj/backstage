...
To use the entity provider, you'll need a [Bitbucket Server integration set up](/integrations/bitbucketServer/locations).
...
- **`host`**:
  The host of the Bitbucket Server instance, **note**: the host needs to registered as an integration as well, see [location](/integrations/bitbucketServer/locations).
