...
3. Work with senior tech leadership and architects to ensure your organization's
   ...
   [Software Templates](/features/software-templates).
...
customers. This is done primarily by building [plugins](/plugins).
...
> [maintain their own API](/plugins/call-existing-api), they can improve
> their product by iterating on API and UI in lockstep. Because the plugin
> follows our [platform design guidelines](/dls/design) their customers get
...
- **Fragmentation** _(Experimental)_ - Backstage
  [Software Templates](/features/software-templates) help drive
