...
This section is part of the legacy plugins documentation. For the new frontend system version, see [Plugin Analytics](/frontend-system/building-plugins/08-analytics). The concepts and events described here apply to both the old and new frontend systems.
