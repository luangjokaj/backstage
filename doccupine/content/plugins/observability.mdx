...
This section is part of the legacy plugins documentation. For new backend system logging, see the [Logger](/backend-system/core-services/logger) and [Root Logger](/backend-system/core-services/root-logger) core service documentation. For health checks, see [Root Health](/backend-system/core-services/root-health).
...
[here](/integrations/datadog-rum/installation).
...
[`rootLogger`](/backend-system/core-services/root-logger), as well as a plugin
based logger, [`logger`](/backend-system/core-services/logger) from `coreServices`.
