...
> Package roles were introduced in March 2022. To migrate existing projects, see the [migration guide](/tutorials/package-role-migration).
...
[monorepo](/references/glossary#monorepo), will stay intact.
...
More details are given in the [Module Federation](/frontend-system/building-apps/07-module-federation#building-module-federation-remotes) documentation.
...
[bundle](/references/glossary#bundle), all contained within a single
...
the section on [metadata for published packages](/tooling/package-metadata#metadata-for-published-packages).
