...
around the project. Creating new [apps](/references/glossary#app) and
[plugins](/references/glossary#plugin) should be simple, iteration
...
[`@backstage/cli`](https://www.npmjs.com/package/@backstage/cli) [package](/references/glossary#package). When
...
in-depth look into the tooling, see the [build system](/tooling/cli/02-build-system)
page, and for a list of commands, see the [commands](/tooling/cli/03-commands) page.
