...
# ADR013: [superseded] Proper use of HTTP fetching libraries

<Callout type="note">

**Superseded**

This ADR has been superseded by [ADR014](/architecture-decisions/adr014-use-fetch) and no longer applies.
