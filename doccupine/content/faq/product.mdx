...
Backstage by writing [a plugin](/faq/technical#what-is-a-plugin-in-backstage).
...
[Plugins](/faq/technical#what-is-a-plugin-in-backstage) are the building blocks of
...
[our project roadmap](/overview/roadmap). Even though the open source version
