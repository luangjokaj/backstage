...
The service works in conjunction with the [Actions Registry Service](/backend-system/core-services/actions-registry), where actions are registered by plugins and then made available for discovery and execution through this service.
...
For more details on how to declare secrets in an action, see the [Actions Registry Secrets](/backend-system/core-services/actions-registry#secrets) documentation.

## Best Practices

For comprehensive guidance on action design, naming conventions, and schema design, see the [Actions Registry Best Practices](/backend-system/core-services/actions-registry#best-practices) documentation.
