...
This service is deprecated, you are likely looking for the [Auth Service](/backend-system/core-services/auth) instead. If you're wondering how to get the user's entity ref and ownership claims in your backend plugin, you should see the [User Info Service](/backend-system/core-services/user-info) documentation.
