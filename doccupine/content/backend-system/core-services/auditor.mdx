...
- **Documentation Example:**
  - The "Audit Events" section of the Software Catalog [Audit Documentation](/features/software-catalog/audit-events) provides a well-structured example of documenting emitted audit events.
