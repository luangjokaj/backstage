...
<span className="textGreen">different Apps</span>, that provide
<span className="textBlue"> different implementations</span> of the
<span className="textPurple"> FooApi</span>.
<span className="textYellow"> Components</span> within Plugins then access the
<span className="textPurple"> FooApi</span> via the
<span className="textRed"> fooApiRef</span>.
