...
This section covers many of the [extension blueprints](/frontend-system/architecture/23-extension-blueprints) available at your disposal when building Backstage frontend plugins.

## Extension blueprints in `@backstage/frontend-plugin-api`

These are the [extension blueprints](/frontend-system/architecture/23-extension-blueprints) provided by the Backstage frontend framework itself.

### Api - [Reference](https://backstage.io/api/stable/variables/_backstage_frontend-plugin-api.index.ApiBlueprint.html)

An API extension is used to add or override [Utility API factories](/frontend-system/utility-apis/01-index) in the app. They are commonly used by plugins for both internal and shared APIs. There are also many built-in Api extensions provided by the framework that you are able to override.
...
These are the [extension blueprints](/frontend-system/architecture/23-extension-blueprints) provided by the Catalog plugin.
...
These are the [extension blueprints](/frontend-system/architecture/23-extension-blueprints) provided by the Search plugin.
