...
To have a better understanding of extension data references please read [the corresponding architecture section](/frontend-system/architecture/20-extensions#extension-data) first.
