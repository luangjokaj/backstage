...
[Configuration Files](/conf/writing#configuration-files) section.
...
For more details, see [Writing Configuration](/conf/writing).
...
[Defining Configuration](/conf/defining).
...
[Reading Configuration](/conf/reading) and
[Defining Configuration](/conf/defining).
...
- [Reading Configuration](/conf/reading): How to read configuration in your
  plugin.
- [Writing Configuration](/conf/writing): How to write configuration for your
  Backstage deployment.
- [Defining Configuration](/conf/defining): How to define a configuration schema
