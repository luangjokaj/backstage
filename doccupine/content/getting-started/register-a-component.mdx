...
[Descriptor Format of Catalog Entities](/features/software-catalog/descriptor-format) provides additional information on the format of the YAML entity files.
