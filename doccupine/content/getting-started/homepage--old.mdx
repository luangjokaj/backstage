...
# Backstage homepage - Setup and Customization (Old Frontend System)
...
[current homepage guide](/getting-started/homepage) instead.
...
- You have created your own standalone Backstage app using
  [`@backstage/create-app`](/getting-started#creating-and-running-a-backstage-application) and not
