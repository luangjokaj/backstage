...
# Configuring App with plugins (Old Frontend System)
...
[current guide](/getting-started/configure-app-with-plugins) instead.
...
[@backstage/create-app](/getting-started), the sidebar is managed inside
