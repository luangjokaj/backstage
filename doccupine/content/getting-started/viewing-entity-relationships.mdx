...
You can also view the relationships in the [Catalog Graph](/features/software-catalog/creating-the-catalog-graph). This view allows you to filter what entities and relationships to display.
