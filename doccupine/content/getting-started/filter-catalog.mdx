...
The Catalog can be filtered by any combination of owner, kind, type, lifecycle, processing status, namespace, and name. [Catalog filters](/features/software-catalog/catalog-customization#catalog-filters) provides information on how to modify the available filter criteria.

![Catalog filter options](/assets/uiguide/catalog-filter-options.png)

The [Technical Overview](/overview/technical-overview#software-catalog-system-model) provides a description of the types of entities displayed in the Catalog.
...
- **Filter by Processing Status**
  ...
  Use the `Processing Status` dropdown to restrict the displayed list to only include those entities which are [orphaned](/features/software-catalog/life-of-an-entity#orphaning) or [in error](/features/software-catalog/life-of-an-entity#errors).
