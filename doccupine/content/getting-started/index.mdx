...
- Node.js [Active LTS Release](/overview/versioning-policy#nodejs-releases) installed using one of these
  methods:
...
**Browser window didn't open with yarn start**
...
- Configuring Backstage
  - [Setting up authentication](/getting-started/config/authentication)
  - [Configuring a database](/getting-started/config/database)
  - [Adding plugins](/getting-started/configure-app-with-plugins)
  - [Customizing Your App's UI](/conf/user-interface)
  - [Populating the homepage](/getting-started/homepage)
- Deploying to production
  - [Deploying with Docker](/deployment/docker)
  - [Deploying with Kubernetes](/deployment/k8s)
...
- Using your Backstage instance
  ...
  - [Register a component](/getting-started/register-a-component)
  - [Create a new component](/getting-started/create-a-component)
  - [Update a component](/getting-started/update-a-component)
  - [Unregistering and deleting a component](/getting-started/unregister-delete-component)
