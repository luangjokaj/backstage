...
read the [old frontend system version of this guide](/auth/oidc--old)
instead.
...
If none of the built-in resolvers are suitable, you can write a custom resolver. See [Building Custom Resolvers](/auth/identity-resolver#building-custom-resolvers) for details.
...
For a more detailed explanation about resolvers, see the [Identity Resolver](/auth/identity-resolver) page.
...
For more information about sign-in configuration, see [Sign-in Configuration](/auth#sign-in-configuration).
