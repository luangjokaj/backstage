...
This setup enables the [Kubernetes plugin](/features/kubernetes) to access OpenShift clusters using the user's permissions,
leveraging OAuth 2.0 _On-Behalf-Of_ flow via the [Kubernetes Client Side Provider](/features/kubernetes/authentication).
