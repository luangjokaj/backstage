...
configured to allow sign-in. See the [Sign-in Identities and Resolvers](/auth/identity-resolver)
...
[sign-in resolver documentation](/auth/identity-resolver#sign-in-without-users-in-the-catalog).
